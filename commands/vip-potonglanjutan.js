  ...
  bot.on("message", async (msg) => {
    ...
    if (session.step === 2) {
      ...
      if (session.splitCounter === 1) {
        ...
        bot.sendMessage(chatId, `📄 *Berapa kontak per file ya Kak?*`, { parse_mode: "Markdown", reply_markup: bot.getMainKeyboard() });
      }
      return;
    }
